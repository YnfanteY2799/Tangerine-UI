...
var peeledBgVariants = (0, import_class_variance_authority.cva)("", {
  variants: {
    color: {
...
var progressVariants = (0, import_class_variance_authority.cva)("", {
  variants: {
    color: {
...
var rippleVariants = (0, import_class_variance_authority.cva)("absolute rounded-full pointer-events-none", {
  variants: {
    color: {
...
var long_press_indicator_default = (0, import_react34.memo)(function LongPressIndicator(props) {
  const { progress, color = "default", variant = "solid", duration = 500 } = props;
  const remainingDuration = (0, import_react34.useMemo)(() => duration * (1 - progress) / 1e3, [duration, progress]);
  const { backdrop, background } = (0, import_react34.useMemo)(() => getProgressStyles(color, variant), [color, variant]);
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(import_react33.LazyMotion, { features: import_react33.domAnimation, strict: true, children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
    import_react33.m.div,
    {
      "aria-hidden": "true",
      role: "presentation",
      exit: { opacity: 0 },
...
var cooldown_indicator_default = (0, import_react36.memo)(function CooldownIndicator({ progress, color = "default", className }) {
  const clampedProgress = Math.min(Math.max(progress, 0), 1);
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(import_react35.LazyMotion, { features: import_react35.domAnimation, strict: true, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: cn("pointer-events-none absolute inset-0 overflow-hidden", className), "aria-hidden": "true", role: "presentation", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
    import_react35.m.div,
    {
...
function useLongPress2(options = {}) {
  ...
  const touchStartPosRef = (0, import_react37.useRef)(null);
  const timerRef = (0, import_react37.useRef)(null);
  const animationFrameRef = (0, import_react37.useRef)(null);
  const startTimeRef = (0, import_react37.useRef)(0);
  const [isLongPress, setIsLongPress] = (0, import_react37.useState)(false);
  const [isPressed, setIsPressed] = (0, import_react37.useState)(false);
  const [progress, setProgress] = (0, import_react37.useState)(0);
  const onLongPressRef = (0, import_react37.useRef)(onLongPress);
  const onPressRef = (0, import_react37.useRef)(onPress);
  const onStartRef = (0, import_react37.useRef)(onStart);
  (0, import_react37.useEffect)(() => {
    onLongPressRef.current = onLongPress;
    onPressRef.current = onPress;
    onStartRef.current = onStart;
  }, [onLongPress, onPress, onStart]);
  const updateProgress = (0, import_react37.useCallback)(() => {
  ...
  const cleanup = (0, import_react37.useCallback)(() => {
    if (timerRef.current) {
  ...
  const start = (0, import_react37.useCallback)(
    (event) => {
      if (disabled) return;
  ...
  const stop = (0, import_react37.useCallback)(
  ...
  const handleTouchMove = (0, import_react37.useCallback)(
    (event) => {
  ...
  const cancel = (0, import_react37.useCallback)(() => reset(), [reset]);
  (0, import_react37.useEffect)(() => {
    return () => cleanup();
  }, [cleanup]);
  const handlers = {
...
function useCooldown(options = {}) {
  ...
  const [cooldownProgress, setCooldownProgress] = (0, import_react38.useState)(0);
  const [isInCooldown, setIsInCooldown] = (0, import_react38.useState)(false);
  const [clickCount, setClickCount] = (0, import_react38.useState)(0);
  const progressIntervalRef = (0, import_react38.useRef)(null);
  const cooldownTimerRef = (0, import_react38.useRef)(null);
  const onCooldownStartRef = (0, import_react38.useRef)(onCooldownStart);
  const onCooldownEndRef = (0, import_react38.useRef)(onCooldownEnd);
  const cooldownStartTimeRef = (0, import_react38.useRef)(0);
  ...
  const startCooldown = (0, import_react38.useCallback)(() => {
  ...
  const resetCooldown = (0, import_react38.useCallback)(() => {
    clearTimers();
    setIsInCooldown(() => false);
    setCooldownProgress(() => 0);
    setClickCount(() => 0);
  }, [clearTimers]);
  const getRemainingTime = (0, import_react38.useCallback)(() => {
...
function useHaptic(options = {}) {
  ...
  const isSupported = (0, import_react39.useMemo)(() => typeof navigator !== "undefined" && "vibrate" in navigator && typeof navigator.vibrate === "function", []);
  const stopVibration = (0, import_react39.useCallback)(() => {
    if (isSupported) {
      try {
        navigator.vibrate(0);
      } catch (error) {
  ...
  const vibrate = (0, import_react39.useCallback)(
    (pattern = "light") => {
...
function useRipple2(options = {}) {
  ...
  const timeoutRefs = (0, import_react40.useRef)(/* @__PURE__ */ new Map());
  const rippleKeyRef = (0, import_react40.useRef)(0);
  const [ripples, setRipples] = (0, import_react40.useState)([]);
  const clearRipple = (0, import_react40.useCallback)((key) => {
  ...
  const clearAllRipples = (0, import_react40.useCallback)(() => {
    setRipples(() => []);
    timeoutRefs.current.forEach((timeout) => clearTimeout(timeout));
    timeoutRefs.current.clear();
  }, []);
  const createRipple = (0, import_react40.useCallback)(
    (event) => {
      if (disabled) return;
...
var progress_bar_default = (0, import_react42.memo)(function ProgressBar({ progress, placement, color = "default", className }) {
  ...
  const renderContent = () => {
    switch (placement) {
      ...
      case "label":
        return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_react41.AnimatePresence, { mode: "wait", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
          import_react41.m.span,
          {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_react41.LazyMotion, { features: import_react41.domAnimation, strict: true, children: renderContent() });
});
...
var RippleItem = (0, import_react44.memo)(function RippleItem2({ ripple, color, onComplete }) {
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
    import_react43.m.span,
    {
...
var ripple_default = (0, import_react44.memo)(function RippleContainer3({ onAnimationComplete, color = "default", className, ripples }) {
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_react43.LazyMotion, { features: import_react43.domAnimation, strict: true, children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { className: cn("pointer-events-none absolute inset-0 overflow-hidden", className), "aria-hidden": "true", role: "presentation", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_react43.AnimatePresence, { mode: "popLayout", children: ripples.map((ripple) => /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(RippleItem, { ripple, color, onComplete: () => onAnimationComplete(ripple.key) }, ripple.key)) }) }) });
});
...
var SCALE_VALUE = 0.8;
var spinner_default = (0, import_react46.memo)(function Spinner({ size = "md", className, label = "loading" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_react45.LazyMotion, { features: import_react45.domAnimation, strict: true, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    import_react45.m.svg,
    {
      ...
      fill: "none",
      children: [
        label && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("title", { children: label }),
...
var Button_default = (0, import_react48.memo)(function Button(innerProps) {
  const {
    // Composition
    asChild = false,
    // Identity
  ...
  const uniqueId = id ?? (0, import_react48.useId)();
  const prefersReducedMotion = (0, import_react47.useReducedMotion)();
  const buttonRef = (0, import_react48.useRef)(null);
  const lastClickTimeRef = (0, import_react48.useRef)(0);
  const doubleClickTimeoutRef = (0, import_react48.useRef)(null);
  ...
  const combinedRef = (0, import_react48.useCallback)(
    (node) => {
  ...
  const hoverVariant = (0, import_react48.useMemo)(() => shouldDisableAnimation ? {} : getHoverVariant(hoverAnimation), [hoverAnimation, shouldDisableAnimation]);
  const pressVariant = (0, import_react48.useMemo)(() => shouldDisableAnimation ? {} : getPressVariant(pressAnimation), [pressAnimation, shouldDisableAnimation]);
  const entranceExitVariant = (0, import_react48.useMemo)(() => {
  ...
  const handleKeyDownUpdated = (0, import_react48.useCallback)(
    (event) => {
  ...
  const buttonClassName = (0, import_react48.useMemo)(
    () => cn(
      buttonVariants({
        size,
        color,
  ...
  const accessibilityProps = (0, import_react48.useMemo)(() => {
    const attrs = {
  ...
  const renderSpinner = (0, import_react48.useMemo)(() => {
    if (!isLoading) return null;
    return spinner || /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(spinner_default, { size });
  }, [isLoading, spinner, size]);
  const renderPeeledContent = (0, import_react48.useMemo)(() => {
  ...
  const renderContent = (0, import_react48.useMemo)(() => {
    ...
    if (effectiveIsIconOnly) {
      return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.AnimatePresence, { mode: "wait", children: isLoading ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: true,
          "aria-hidden": "true",
          exit: { opacity: 0, scale: 0.9 },
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.AnimatePresence, { mode: "wait", children: isLoading && spinnerPlacement === "start" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: true,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.AnimatePresence, { mode: "wait", children: showProgressAsLabel && showProgressText ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(progress_bar_default, { progress, placement: "label", color }, "progress-label") : /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: true,
          className: "truncate",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.AnimatePresence, { mode: "wait", children: isLoading && spinnerPlacement === "end" ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: true,
          "aria-hidden": "true",
        ...
        "spinner-end"
      ) : endContent ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: true,
          "aria-hidden": "true",
  ...
  const motionProps = (0, import_react48.useMemo)(
    () => ({
      layoutRoot: true,
      layout: "size",
  ...
  const htmlProps = (0, import_react48.useMemo)(
    () => ({
      ref: combinedRef,
  ...
  const buttonContent = (0, import_react48.useMemo)(
    () => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_jsx_runtime20.Fragment, { children: [
      !disableRipple && !shouldDisableAnimation && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(ripple_default, { ripples, color, onAnimationComplete: clearRipple }),
      typeof progress === "number" && progressPlacement !== "label" && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(progress_bar_default, { color, progress, placement: progressPlacement }),
      showCooldownIndicator && isInCooldown && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(cooldown_indicator_default, { progress: cooldownProgress }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.AnimatePresence, { children: showLongPressIndicator && isLongPressing && onLongPress && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(long_press_indicator_default, { progress: longPressProgress, color, variant, duration: longPressDelay }) }),
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
        import_react47.m.span,
        {
          layout: "size",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(import_react47.LazyMotion, { strict: true, features: import_react47.domMax, children: [
    asChild ? (
      // SOLUTION: Wrap Slot with motion to preserve animations when asChild is used
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.m.span, { ...motionProps, style: { display: "inline-block", isolation: "isolate", ...motionProps.style }, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react_slot.Slot, { ...htmlProps, "data-button-wrapper": "true", children: buttonContent }) })
    ) : (
      // Original motion.button rendering
      /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(import_react47.m.button, { type, ...motionProps, ...htmlProps, children: buttonContent })
    ),
    isLoading && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { id: loadingAnnouncementId, role: "status", "aria-live": "polite", "aria-atomic": "true", className: "sr-only", children: loadingText }),
    typeof progress === "number" && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { id: progressAnnouncementId, role: "status", "aria-live": "polite", "aria-atomic": "true", className: "sr-only", children: `Progress: ${Math.round(progress)}%` })
  ] });
});
...
var button_group_default = (0, import_react49.memo)(function ButtonGroup(props) {
  const {
    children,
    className,
    role = "group",
  ...
  const childArray = (0, import_react49.useMemo)(() => import_react49.Children.toArray(children).filter(import_react49.isValidElement), [children]);
  const totalCount = childArray.length;
  const staggerVariant = (0, import_react49.useMemo)(() => getStaggerVariant(staggerAnimationType), [staggerAnimationType]);
  const containerVariants = (0, import_react49.useMemo)(
    () => ({
  ...
  const itemVariants = (0, import_react49.useMemo)(() => ({ hidden: staggerVariant.initial, visible: staggerVariant.animate }), [staggerVariant]);
  const enhancedChildren = (0, import_react49.useMemo)(() => {
    return childArray.map((child, index) => {
      if (!(0, import_react49.isValidElement)(child)) return child;
      ...
      const enhancedChild = (0, import_react49.cloneElement)(child, {
        ...internalProps,
        className: cn(child.props.className, radiusOverride)
      });
      return staggerAnimation ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_react50.m.div, { variants: itemVariants, children: enhancedChild }, index) : /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_react49.Fragment, { children: enhancedChild }, index);
    });
  }, [childArray, totalCount, staggerAnimation, staggerDelay, staggerDirection, spacing, orientation, itemVariants]);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(import_react50.LazyMotion, { features: import_react50.domAnimation, strict: true, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
    import_react50.m.div,
    {
      className: cn(
        "inline-flex",
